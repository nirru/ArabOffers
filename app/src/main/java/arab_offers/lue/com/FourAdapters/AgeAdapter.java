...
public class AgeAdapter extends RecyclerView.Adapter<AgeAdapter.ViewHolder>{
    static  int k=0;
    ArrayList<String> loadEntities=new ArrayList<String>();
    Activity context1;
    View getView1;
    View view1;
    PassText passText=null;
    int click=0;
    public AgeAdapter(Activity context2, ArrayList<String> loadEntities, PassText passText){
    ...
    @Override
    public AgeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
    ...
    public void onBindViewHolder(final ViewHolder Vholder, final int position){
       // Vholder.checktext.setText(loadEntities.get(position).getName());
        ...
        try {
            Vholder.checktext.setText(loadEntities.get(position));
