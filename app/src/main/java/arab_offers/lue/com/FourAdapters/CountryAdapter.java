...
public class CountryAdapter extends RecyclerView.Adapter<CountryAdapter.ViewHolder>{
    static  int k=0;
    ArrayList<CountryModel> loadEntities=new ArrayList<CountryModel>();
    Activity context1;
    View getView1;
    View view1;
    PassText passText=null;
    int click=0;
    public CountryAdapter(Activity context2, ArrayList<CountryModel> loadEntities, PassText passText){
