...
import arab_offers.lue.com.CircleRefreshLayout;
...
import arab_offers.lue.com.PagerActivity;
...
public class Tab1 extends Fragment {
    ...
    static  OfferAdapter offerAdapter;

    ArrayList<OfferModel> modelObjs= new ArrayList<OfferModel>();
    ArrayList<Object> offerModel= new ArrayList<Object>();
    //Overriden method onCreateView
     int offset1=0;
    private NativeAdsManager listNativeAdsManager;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab1,
                container, false);
        //Returning the layout file after inflating 
        //Change R.layout.tab1 in you classes

        list1= (PullAndLoadListView)rootView.findViewById(R.id.list_1);
        yourPreference=YourPreference.getInstance(getContext());

        getsAllOfferData(yourPreference.getDataInteger("user_id"),3,0);
        return rootView;
    }
    ...
    private void getsAllOfferData(int user_id, int type, final int offset)  {
        try {
...
//                            if((offerModel.size()*3)%15==0){
//                                offerModel.add(new OfferModel("A", "", "", "", "", "", "", "", "", false,null));
//                            }
//                            if((offerModel.size()*4)%15==0){
//                                offerModel.add(new OfferModel("B", "", "", "", "", "", "", "", "", false,null));
//                            }
                        }
...
public void searchable(){
    ...
    public void search(String text) {
        Log.i("search", "searched");
        offerAdapter.getFilter().filter(text.toString());
    }*/
