...
public class Tab2 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tab2,
                container, false);
        //Returning the layout file after inflating
        //Change R.layout.tab1 in you classes

        list1= (PullAndLoadListView)rootView.findViewById(R.id.list_2);
        yourPreference=YourPreference.getInstance(getContext());

        getsAllOfferData(yourPreference.getDataInteger("user_id"),2,0);
